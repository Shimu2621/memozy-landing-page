      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
              ...
              <div className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    title: "Smart Search",
                    description:
                      "Find your notes instantly with powerful keyword searches.",
                  },
                  {
                    icon: Share2,
                    title: "Easy Sharing",
                  ...
                  },
                  {
                    ...
                    description:
                      "Organize your notes with tags and category for easy retrieval.",
                  },
                ].map((item, index) => (
                  <motion.div
                    key={index}
            ...
            >
              Never lose a thought again. Memozy keeps your idea safe and
              organized.
            </motion.p>
          </motion.div>
