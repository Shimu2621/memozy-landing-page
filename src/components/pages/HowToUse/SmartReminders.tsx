...
import { Clock, Bell, Calendar, Phone } from "lucide-react";
              ...
              <div className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Schedule reminder for specific date, time, and recurring event.",
                  },
                  {
                    icon: Phone,
                    title: "Meeting & Call Alerts",
                    description:
                      "Get notified before important calls, meetings, and appointments.",
                  },
                  {
                    icon: Bell,
                    title: "Intelligent Notifications",
                    description:
                      "Receive timely alert that helps you stay organized and productive.",
                  },
                ].map((feature, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-slate-700 dark:text-blue-100 font-outfit text-xs md:text-sm">
                        {feature.description}
                      </p>
                    </div>
                  </motion.div>
