...
import { Search, Filter, Tags, FileSearch } from "lucide-react";
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <motion.div
              variants={isMobile ? {} : itemVariants}
              className="bg-blue-500/10 dark:bg-white/10 backdrop-blur-md rounded-2xl p-4 md:p-6 border border-blue-400 dark:border-white/20"
            >
              ...
              <div className="space-y-3">
                {[
                  ...
                  <motion.div
                    key={index}
                    variants={isMobile ? {} : itemVariants}
                    className="flex gap-3 md:gap-4 dark:hover:bg-white/10 hover:bg-blue-500/10 dark:bg-white/5 backdrop-blur-sm rounded-xl p-3 md:p-4 border border-blue-500 dark:border-white/10 transition-colors cursor-pointer"
                  >
                    <feature.icon className="w-5 h-5 md:w-6 md:h-6 text-blue-500 dark:text-blue-300 flex-shrink-0 mt-1" />
                    <div>
            ...
            <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md">
              ...
              <div className="relative bg-black rounded-3xl shadow-2xl overflow-hidden border-5 border-gray-200">
                ...
                <div className="relative w-full aspect-[9/16] bg-black overflow-hidden">
                  ...
                  >
                    <source
                      src="https://res.cloudinary.com/dsn66l0iv/video/upload/v1760699927/Purple_Gradient_Coming_Soon_Mobile_Video_4_q3jehr.webm"
                      type="video/webm"
                    />
                  </video>
                  <motion.div
