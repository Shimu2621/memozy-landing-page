...
export default function StayOnSchedule() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Get a comprehensive view of your entire week to plans ahead and stay organized.",
    },
    {
      icon: Bell,
      title: "Smart Notifications",
      description:
        "Receive timely reminder before your appointment so you will never miss anything.",
    },
    {
      icon: Zap,
      title: "Seamless Integration",
      description:
        "Sync with your calendar app for a unified scheduling experience.",
    },
  ];
