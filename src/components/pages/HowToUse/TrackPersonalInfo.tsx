          ...
          >
            ...
            >
              ...
              <p className="text-lg md:text-xl text-slate-800 dark:text-emerald-100 font-outfit">
                ...
                personal detail in one secure places.
              </p>
            </motion.div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Keep track of gift idea, favorite food, and other preference.",
                  },
                  {
                    icon: Users,
                    title: "Contact Details",
                    description:
                      "Store important contact information for friend and family.",
                  },
                  {
                    icon: FileText,
                    title: "Important Documents",
                    description:
                      "Securely save copies of important document and information.",
                  },
                ].map((feature, index) => (
                  <motion.div
                    key={index}
