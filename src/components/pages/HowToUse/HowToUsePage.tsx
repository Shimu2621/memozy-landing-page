...
export const HowToUsePage = () => {
  ...
  const howToSchema = {
    ...
    description:
      "Learn how to use Memozy to capture idea, set reminder, manage your schedule, and much more.",
    step: [
      {
        "@type": "HowToStep",
        name: "Capture Ideas & Notes Instantly",
        text: "With Memozy, you can save note anytime using voice or text. For example, say 'Memozy, save a note: Brainstorm ideas for my next projects.'",
        url: "https://www.memozy.ai/how-to-use-memozy.html#note-taking",
      },
      {
        "@type": "HowToStep",
        name: "Set Smart Reminders & Never Forget Tasks",
        text: "Memozy help you set reminders effortlessly, so you never miss important moment. For example, say 'Remind me tomorrow at 10 AM to call Mr. Smith.'",
        url: "https://www.memozy.ai/how-to-use-memozy.html#smart-reminders",
      },
      {
        "@type": "HowToStep",
        name: "Stay on Top of Your Schedule",
        text: "View and manage appointment with ease. Never miss an important meetings or events again. For example, ask 'What appointments do I have this week?'",
      ...
      },
      {
        ...
        text: "Need to find a note or task? Just ask! For example, say 'Show me my note about marketing.'",
        url: "https://www.memozy.ai/how-to-use-memozy.html#find-anything",
      },
      {
        "@type": "HowToStep",
        name: "Prompt Explorer",
        text: "Unlock your creativity with a universe of prompt. For example, say 'Give me a tarot reading for my current situations.'",
        ...
        >
          ...
          >
            <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-center text-white/95 drop-shadow-md text-balance font-light leading-relaxed">
              ...
              guides. This page show you how to create reminders, add and
