  ...
  const howToSchema = {
    ...
    step: [
      ...
      },
      {
        ...
        text: "Memozy helps you set reminders effortlessly, so you never miss important moment. For example, say 'Remind me tomorrow at 10 AM to call Mr. Smith.'",
        url: "https://www.memozy.ai/how-to-use-memozy.html#smart-reminders",
      },
      {
        "@type": "HowToStep",
        name: "Stay on Top of Your Schedule",
        text: "View and manage appointments with ease. Never miss an important meetings or events again. For example, ask 'What appointments do I have this week?'",
