    ...
    step: [
      {
        ...
        text: "With Memozy, you can save notes anytime using voice or text. For example, just say, “Memozy, save a note: Brainstorm ideas for my next project.'",
      ...
      },
      {
        ...
        text: "View and manage appointment with ease. Never miss an important meetings or events again. For example, ask 'What appointment do I have this week?'",
      ...
      },
      {
        ...
        text: "Unlock your creativity with a universe of prompt. For example, say 'Give me a tarot's reading for my current situation.'",
        ...
        >
          ...
          >
            <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-center text-white/95 drop-shadow-md text-balance font-light leading-relaxed">
              ...
              guide. This page show you how to create reminder, add and
